...
旧数据库还需按顺序执行 `database/migrations/002_create_checkin_anomalies.sql`、`database/migrations/003_create_organizer_applications.sql`、`database/migrations/004_create_feedbacks.sql`、`database/migrations/005_create_notifications.sql`、`database/migrations/006_add_activity_cancellation.sql` 和 `database/migrations/007_create_activity_announcements.sql`。
